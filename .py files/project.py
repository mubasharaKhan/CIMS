...
#        Title
     ...
     #--Clock---
        ...
        btn_Customer=Button(LeftMenu,text='Customer',command=self.customer,image=self.icon_side,compound=LEFT,padx=5,anchor='w',font=("times new roman",18,"bold"), bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
